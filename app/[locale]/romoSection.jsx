  ...
  return (
    <section className="bg-customGreyFour relative max-sm:bg-white">
      <div className="max-w-screen-xl mx-auto pt-16 flex flex-col max-sm:pt-6 max-sm:px-4">
        <div className="flex flex-col gap-11 bg-customOrangeThree rounded-t-[80px] pt-[87px] pb-[67px] pl-[87px] max-sm:px-6 max-sm:py-11 max-sm:rounded-[44px] max-sm:relative max-sm:z-10">
          <p className="max-w-[1038px] text-[44px] font-medium leading-[52.8px] text-white max-sm:text-[20px] max-sm:leading-[24px] max-sm:font-semibold">
            With this strategy, you'll effortlessly learn how to identify trends
            and maximize their potential and your profit
          </p>
        ...
        <div className="rounded-b-[80px] relative max-sm:rounded-b-[44px] max-sm:h-[136px] max-sm:bottom-10 max-sm:z-0">
          <Link
            ...
            className="absolute z-20 bottom-16 left-24 flex-1 max-sm:bottom-8 max-sm:left-0 max-sm:right-0"
          >
            <button
              type="button"
