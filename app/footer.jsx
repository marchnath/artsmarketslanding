      ...
      <div className="mx-auto max-w-[1240px] pb-[91px] pt-[100px]">
        ...
        <div className="mb-[101px] flex flex-row gap-9">
          ...
          <ul className="flex flex-col gap-2">
            <li className="text-[12px] leading-[14.4px] text-customBlackOne">Artsmrkts Ltd, registration number 2023-00238, address: Syrakouson 9, Office 106, 3077, Limassol, Cyprus, is the Saint Vincent And the Grenadies company, which provides certain content and operates the business including in terms of processing payment transactions.</li>
            <li className="text-[12px] leading-[14.4px] text-customBlackOne">Artsmrkts Ltd Registered Office address: Fortgate Offshore Investment and Legal Services Ltd. Ground Floor, The Sotheby Building, Rodney Village, Rodney Bay, Gros-Islet, Saint Lucia.
