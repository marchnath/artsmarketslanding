                    ...
                    <div className="flex flex-col gap-1 py-3 max-sm:pt-2 max-sm:pb-0">
                        <div className="items-top flex space-x-2 items-center max-sm:items-start">
                            ...
                            <div className="grid gap-1.5 leading-none">
                                ...
                                >
                                    I agree to the processing of personal data in accordance with the <span
                                    className="underline text-customRedText active:bg-customOrangeFour">Privacy Policy</span>
                                </label>
                            </div>
                        </div>
