...
const TradingStrategy = ({isActive, formSubmitted, setFormSubmitted, setIsActive, ref }) => {
    return (
        <section className="relative rounded-b-[80px] overflow-hidden pb-[84px]" id="tradingStrategy" ref={ref}>
